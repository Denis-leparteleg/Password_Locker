...
class TestUser(unittest.TestCase):
    def setUp(self):
        ...
        """
        self.new_user = User("Denis", "Leparteleg",
                             "DLeparteleg", "pass123")
    ...
    def test_user_created(self):
        ...
        self.assertEqual(self.new_user.username, "DLeparteleg")
    ...
    def test_find_user(self):
        ...
        """
        self.found_user = User.find_user("DLeparteleg")

    def test_user_exists(self):
        """
        check whether the user account exists in the user accounts list
        """
        self.found_user = User.user_exist("DLeparteleg")
